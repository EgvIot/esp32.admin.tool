...
#include <WiFi.h>
#include <DNSServer.h>
#include <ESPmDNS.h>        //https://www.ionos.es/digitalguide/servidores/know-how/multicast-dns/

const byte DNSSERVER_PORT = 53;
DNSServer dnsServer;

IPAddress apIP(192, 168, 4, 1);         //esta es la ip que dara en modo AP
...
void startClient() {
    ...
    if (WiFi.status() == WL_CONNECTED){
        // WiFi Station conectado EJEMPLO nfo: WiFi conectado (-68) IP 192.168.100.119
